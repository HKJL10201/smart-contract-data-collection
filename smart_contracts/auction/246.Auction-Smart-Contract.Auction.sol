...
contract AuctionCreator {
    ...
    function createAuction() public {
        Auction newAuction = new Auction(msg.sender); // When user calls this function it will create a new auction
        auctions.push(newAuction); // This will push the address into auction dynamic array
    }
}
