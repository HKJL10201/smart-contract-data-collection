...
// File: contracts/Auctions/BuyItNowERC721Auction.sol

/**
 * @title BuyItNowERC721Auction
 *
 * @author The AUX Team
 * @notice Contract for a Buy It Now auction of an ERC721 token.
 */


contract BuyItNowERC721Auction is BuyItNowAuction, ERC721Auction {

  /**
  * @notice Creates and starts an auction with the given pricing and asset information.
  * @dev Composes the setup for the BuyItNowAuction, ERC721Auction and AuctionBase.
  */
  function createAuction(uint256 price, address assetAddress, uint256 assetId) whenNotPaused public payable returns (uint256) {
