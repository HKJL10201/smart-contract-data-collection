...
contract AssetManager is Ownable{
    ...
    mapping(uint=>bank) public bankList;
    ...
    function addBankIfNotExist(string memory _bankName) public onlyOwner returns(uint){
    ...
    function addNPA(string memory _bankName,string memory _assetOnAuction,uint _auctionID, string memory _eventType, string memory _city,
        ...
        if(addAuctionIdIfNotExist(_auctionID)<auctionIndex){
            ...
            AssetInterface item = new AssetInterface(0x9B85B1BD8dF7804249699bbd303C22F8936D29B1, this, NPA_ListIndex, _assetOnAuction,
