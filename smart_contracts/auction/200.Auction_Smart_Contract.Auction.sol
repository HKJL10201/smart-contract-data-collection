...
contract Auction {
   ...
   //Structure to hold the details of a persons
    ...
    function Auction() public payable{    //constructor
        ...
        //Initializing beneficiary with address of smart contract’s owner
        beneficiary = msg.sender;
        uint[] memory emptyArray;
        items[0] = Item({itemId:0,itemTokens:emptyArray});
        
        //Initializing two items with at index 1 and 2. 
    ...
    function bid(uint _itemId, uint _count) public payable{
        ...
        */
        ...
        /*
        Implementing the three conditions below.
        ...
        */
        ...
        /*Decrementing the remainingTokens by the number of tokens bid and store the value in balance variable. */
    ...
    // Custom Access Modifier. Creating a modifier named "onlyOwner" to ensure that only owner is allowed to reveal winners
    modifier onlyOwner {
