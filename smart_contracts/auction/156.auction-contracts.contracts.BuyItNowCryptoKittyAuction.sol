...
// File: contracts/Auctions/BuyItNowCryptoKittyAuction.sol

/**
 * @title BuyItNowCryptoKittyAuction
 *
 * @author The AUX Team
 * @notice Contract for a "Buy It Now" auction of a CryptoKitty.
 */


contract BuyItNowCryptoKittyAuction is BuyItNowAuction, CryptoKittyAuction {
  ...
  * @dev Composes the setup for the BuyItNowAuction, CryptoKittyAuction and AuctionBase.
  */
  function createAuction(uint256 price, uint256 kittyId) whenNotPaused public payable returns (uint256) {
