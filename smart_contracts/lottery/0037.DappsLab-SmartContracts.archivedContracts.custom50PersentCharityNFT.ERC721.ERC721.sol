...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    uint256 public _charityComission = 50;
    uint256 public _teamComission = 5;
    address public charityWallet;
    address public teamWallet;
    address public ownership;
    uint256 public initialMintingPrice = 1000000000000000000;
     ...
     */
    constructor(string memory name_, string memory symbol_, uint256 limit) {
        _name = name_;
        _symbol = symbol_;
    ...
    function setInitialMintingPrice(uint256 price) public returns(bool){
        require(msg.sender == ownership, "only Owner is allowed to call this Function");
    ...
    function buyNFT(uint256 tokenId) public payable returns(bool){
        ...
        uint256 team = (_sellPrice[tokenId] * _teamComission) / 100 ;
        (bool sent, bytes memory data) = payable(teamWallet).call{value: team}("");
        require(sent, "Failed to send Ether to Team");
        uint256 remaining = msg.value - _sellPrice[tokenId];
        (bool sent2, bytes memory data2) = msg.sender.call{value: remaining}("");
        require(sent2, "Failed to send remaining Ether");
    ...
    function getCharityComission() public view returns(uint256){
        return _charityComission;
    }

    function setCharityWallet(address addr) public {
        require(msg.sender == ownership, "owner owner is allowd to call this function");
        charityWallet = addr;
    }
    ...
    function setTeamWallet(address addr) public {
        require(msg.sender == ownership, "owner owner is allowd to call this function");
        teamWallet = addr;
    }
