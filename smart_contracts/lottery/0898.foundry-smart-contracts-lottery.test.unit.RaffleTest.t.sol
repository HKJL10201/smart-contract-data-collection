...
contract RaffleTest is Test {
    ...
    function setUp() external {
        ...
        vm.deal(PLAYER, STARTING_USER_BALANCE); // giving this address some money
    }
    ...
    function testEmitsEventOnEntrance() public {
        vm.prank(PLAYER);
        vm.expectEmit(true, false, false, false, address(raffle)); // foundry cheat-code that expect emit from the next contract
    ...
    {
        // Act
        vm.recordLogs(); // record all the logs of the emitted event
    ...
    modifier skipFork() {
        if (block.chainid != 31337) {
            return; // for skipping the test if run on local anvil chain
        }
        _;
    }
