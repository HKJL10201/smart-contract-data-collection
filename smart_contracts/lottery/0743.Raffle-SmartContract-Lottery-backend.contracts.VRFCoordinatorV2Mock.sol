...
/**
 * @dev Below is VRFCoordinatorV2Mock contract including local imports
 * A bug causes performUpkeep test to return EVM Custom error: invalidconsumer()
 * No solution currently available besides import from ChainLink repo
 */

// import "../import/MockImport/LinkTokenInterface.sol";
