...
contract Lottery {
    struct BetInfo{
        ...
        //address bettor;
        byte challenges; // 0xab 같은 1바이트 글자
    }
    ...
    uint256 constant internal BET_BLOCK_INTERVAL = 3; // 3번 이후 블록
    ...
    constructor() public {
        owner = msg.sender; // 배포를 할 때 보낸사람을 owner로 저장
    }
    ...
    function getPot() public view returns (uint256 pot) {
     ...
     /**
      * @dev 배팅과 정답 체크를 한다. 유저는 0.005 ETH를 보내야 하고, 배팅용 1 byte 글자를 보낸다.
