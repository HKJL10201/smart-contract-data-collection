...
contract AlgebraNonfungibleTokenPositionDescriptor is INonfungibleTokenPositionDescriptor {
    // Polygon addresses
    ...
    function tokenURI(
        ...
        return
            AlgebraNFTDescriptor.constructTokenURI(
                AlgebraNFTDescriptor.ConstructTokenURIParams({
                    tokenId: tokenId,
