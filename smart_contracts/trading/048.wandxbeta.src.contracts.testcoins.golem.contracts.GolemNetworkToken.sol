...
contract GolemNetworkToken is ERC20Interface {
    ...
    string constant public name = "Golem Network Tokens";
    string constant public symbol = "GNT"; 
