...
contract MyEpicNFT is ERC721URIStorage {
  ...
  uint256 private _maxTokens = 50;
    ...
    string[] firstWords = ["Tremendous", "Remarkable", "Terrific", "Epic", "Unbelievable", "Extraordinary", "Phenomenal", "Wild", "Extravagant", "Irrational", "Outstanding", "Impressive", "Monumental", "Overwhelming", "implausible", "Incredible", "Fanciful", "Huge"];
    string[] secondWords = ["Pizza", "Shawarma", "Burger", "Sandwich", "Jollof", "Ofada", "Beans", "Potatoes", "Suya", "Fries", "Bread", "Chicken", "Pasta", "Sausages", "Broccoli", "Oatmeal", "Salmon", "Mangoes", "Cheese", "Avocado", "Noodles", "Fish", "Turkey", "Chocolate"];
    string[] thirdWords = ["Hiro", "Shinobu", "Hinata", "Rin", "Kei", "Makoto", "Masashi", "Michi", "Natsu", "Katsu", "Nori", "Noburu", "Michiko", "Momoe", "Haruhi", "Yuuki", "Maki", "Mariko", "Toshiro", "Raiden", "Mikio", "Tatsuya", "Dante", "Rukia"];
