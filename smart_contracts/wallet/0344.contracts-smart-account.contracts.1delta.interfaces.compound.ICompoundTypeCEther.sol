...
import {ICompoundTypeCToken} from "./ICompoundTypeCToken.sol";

/**
 * @title Generic Compound type CEther interface
 * @notice Wraps native currency
 */
interface ICompoundTypeCEther is ICompoundTypeCToken {
    /*** User Interface ***/
     ...
     */
    function liquidateBorrow(address borrower, ICompoundTypeCToken oTokenCollateral) external payable;
