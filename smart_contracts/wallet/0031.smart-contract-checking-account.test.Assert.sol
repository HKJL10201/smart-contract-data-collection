...
/*
    ...
    contract ModAdder {
        ...
        function addMod(uint a, uint b, uint modulus) constant internal returns (uint sum) {
            if (modulus == 0)
                throw;
...
library Assert {
    ...
    */
    ...
    /*
        ...
        Returns:
            result (bool) - false.
    */
    function fail(string message) constant internal returns (bool result) {
    ...
    */
    function equal(string A, string B, string message) constant internal returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(string A, string B, string message) constant internal returns (bool result) {
        result = !_stringsEqual(A, B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isEmpty(string str, string message) constant internal returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isNotEmpty(string str, string message) constant internal returns (bool result) {
        result = !_stringsEqual(str, STRING_NULL);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(bytes32 A, bytes32 B, string message) constant internal returns (bool result) {
        result = (A == B);
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(bytes32 A, bytes32 B, string message) constant internal returns (bool result) {
        result = (A != B);
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isZero(bytes32 bts, string message) constant internal returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isNotZero(bytes32 bts, string message) constant internal returns (bool result) {
        result = (bts != BYTES32_NULL);
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(address A, address B, string message) constant internal returns (bool result) {
        result = (A == B);
        _report(result, message);
    }
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(address A, address B, string message) constant internal returns (bool result) {
        result = (A != B);
         _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isZero(address addr, string message) constant internal returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isNotZero(address addr, string message) constant internal returns (bool result) {
        result = (addr != ADDRESS_NULL);
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isTrue(bool b, string message) constant internal returns (bool result) {
        result = b;
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isFalse(bool b, string message) constant internal returns (bool result) {
        result = !b;
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(bool A, bool B, string message) constant internal returns (bool result) {
        result = (A == B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(bool A, bool B, string message) constant internal returns (bool result) {
        result = (A != B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(uint A, uint B, string message) constant internal returns (bool result) {
        result = (A == B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(uint A, uint B, string message) constant internal returns (bool result) {
        result = (A != B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isAbove(uint A, uint B, string message) constant internal returns (bool result) {
        result = (A > B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isAtLeast(uint A, uint B, string message) constant internal returns (bool result) {
        result = (A >= B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isBelow(uint A, uint B, string message) constant internal returns (bool result) {
        result = (A < B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isAtMost(uint A, uint B, string message) constant internal returns (bool result) {
        result = (A <= B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isZero(uint number, string message) constant internal returns (bool result) {
        result = (number == 0);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isNotZero(uint number, string message) constant internal returns (bool result) {
        result = (number != 0);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(int A, int B, string message) constant internal returns (bool result) {
        result = (A == B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(int A, int B, string message) constant internal returns (bool result) {
        result = (A != B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isAbove(int A, int B, string message) constant internal returns (bool result) {
        result = (A > B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isAtLeast(int A, int B, string message) constant internal returns (bool result) {
        result = (A >= B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isBelow(int A, int B, string message) constant internal returns (bool result) {
        result = (A < B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isAtMost(int A, int B, string message) constant internal returns (bool result) {
        result = (A <= B);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isZero(int number, string message) constant internal returns (bool result) {
        result = (number == 0);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isNotZero(int number, string message) constant internal returns (bool result) {
        result = (number != 0);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(uint[] arrA, uint[] arrB, string message) constant internal returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(uint[] arrA, uint[] arrB, string message) constant internal returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthEqual(uint[] arr, uint length, string message) constant internal returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthNotEqual(uint[] arr, uint length, string message) constant internal returns (bool result) {
        uint arrLength = arr.length;
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(int[] arrA, int[] arrB, string message) constant internal returns (bool result) {
        result = arrA.length == arrB.length;
        if (result) {
            for (uint i = 0; i < arrA.length; i++) {
                if (arrA[i] != arrB[i]) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(int[] arrA, int[] arrB, string message) constant internal returns (bool result) {
        var r = arrA.length == arrB.length;
        if (r) {
            for (uint i = 0; i < arrA.length; i++) {
                if (arrA[i] == arrB[i]) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthEqual(int[] arr, uint length, string message) constant internal returns (bool result) {
        uint arrLength = arr.length;
        if (arrLength == length)
            _report(result, "");
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthNotEqual(int[] arr, uint length, string message) constant internal returns (bool result) {
        uint arrLength = arr.length;
        if (arrLength != arr.length)
            _report(result, "");
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(address[] arrA, address[] arrB, string message) constant internal returns (bool result) {
        result = arrA.length == arrB.length;
        if (result) {
            for (uint i = 0; i < arrA.length; i++) {
                if (arrA[i] != arrB[i]) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(address[] arrA, address[] arrB, string message) constant internal returns (bool result) {
        var r = arrA.length == arrB.length;
        if (r) {
            for (uint i = 0; i < arrA.length; i++) {
                if (arrA[i] == arrB[i]) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthEqual(address[] arr, uint length, string message) constant internal returns (bool result) {
        uint arrLength = arr.length;
        if (arrLength == length)
            _report(result, "");
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthNotEqual(address[] arr, uint length, string message) constant internal returns (bool result) {
        uint arrLength = arr.length;
        if (arrLength != arr.length)
            _report(result, "");
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(bytes32[] arrA, bytes32[] arrB, string message) constant internal returns (bool result) {
        result = arrA.length == arrB.length;
        if (result) {
            for (uint i = 0; i < arrA.length; i++) {
                if (arrA[i] != arrB[i]) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(bytes32[] arrA, bytes32[] arrB, string message) constant internal returns (bool result) {
        var r = arrA.length == arrB.length;
        if (r) {
            for (uint i = 0; i < arrA.length; i++) {
                if (arrA[i] == arrB[i]) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthEqual(bytes32[] arr, uint length, string message) constant internal returns (bool result) {
        uint arrLength = arr.length;
        if (arrLength == length)
            _report(result, "");
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthNotEqual(bytes32[] arr, uint length, string message) constant internal returns (bool result) {
        uint arrLength = arr.length;
        if (arrLength != arr.length)
            _report(result, "");
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function balanceEqual(address A, uint b, string message) constant internal returns (bool result) {
        result = (A.balance == b);
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function balanceNotEqual(address A, uint b, string message) constant internal returns (bool result) {
        result = (A.balance != b);
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function balanceIsZero(address A, string message) constant internal returns (bool result) {
        result = (A.balance == 0);
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function balanceIsNotZero(address A, string message) constant internal returns (bool result) {
        result = (A.balance != 0);
        _report(result, message);
    }
    ...
    */
    ...
    /*
    function htoa(address addr) constant internal returns (string) {
