...
contract StandardToken is ERC20, BasicToken {
 ...
 function approveAndDeposit(Mopayd _exchange, uint _amount) public returns (bool success) {
    allowed[msg.sender][_exchange] = _amount;
    emit Approval(msg.sender, _exchange, _amount);
    _exchange.receiveTokenDeposit(address(this), msg.sender, msg.sender, _amount);
    return true;
  }
