...
contract Ballot {
    ...
    // be used for variables later. It will represent a single voter.

    //startTime variable initiated. It will be set to block.timestamp 
    //by using the constructor. Then I will check if 5 minutes passed on
    // by using voteEnded modifier.
    ...
    constructor(bytes32[] memory proposalNames) {
        ...
        // For each of the provided proposal names, create a new proposal object and add it
