...
// Borrowed from https://github.com/sammayo/solidity-rlp-encoder/blob/master/RLPEncode.sol
// Licenced under MIT

/* Notes:
 * have fixed the formatting
 * changed contsant -> view
 * spaced out operators so you can actually read it
 */
