...
contract TestMiniMeCloning {
  ...
  function testCanClone() {
    clone1 = MiniMeToken(token.createCloneToken("XREDCoin2", 18, "XREDCoin2", block.number, true));
  ...
  function testCanCloneAfterTransfer() {
    clone2 = MiniMeToken(token.createCloneToken("XREDCoin2", 18, "XREDCoin2", block.number, true));
  ...
  function testRecurringClones() {
    ...
    for (uint i = 0; i < 10; i++) {
      lastClone = MiniMeToken(lastClone.createCloneToken("XREDCoinn", 18, "XREDCoinn", block.number, true));
    }
