...
contract TestTokenSale {
  ...
  function testHasCorrectPriceForMultistage() {
    XREDTokenSaleMock sale = new XREDTokenSaleMock(10, 40, address(this), address(this), 5, 1, 3);
  ...
  function testAllocatesTokensInSale() {
    ...
    XREDTokenSaleMock sale = new XREDTokenSaleMock(10, 20, address(ms), address(ms), 3, 1, 2);
    ms.deployAndSetXREDCoin(sale);
  ...
  function throwsWhenGettingTokensInNotInitiatedSale() {
    ...
    XREDTokenSaleMock sale = new XREDTokenSaleMock(10, 20, address(ms), address(this), 3, 1, 2);
    ms.deployAndSetXREDCoin(sale);
    ms.activateSale(sale);
  ...
  function testTokensAreTransferrableAfterSale() {
    ...
    Assert.equal(XREDCoin(sale.token()).controller(), address(sale), "Sale is controller during sale");
    ...
    Assert.equal(XREDCoin(sale.token()).controller(), sale.networkPlaceholder(), "Network placeholder is controller after sale");
  ...
  function testNetworkDeployment() {
    ...
    XREDTokenSaleMock sale = new XREDTokenSaleMock(10, 20, address(devMultisig), address(communityMultisig), 3, 1, 2);
    devMultisig.deployAndSetXREDCoin(sale);
