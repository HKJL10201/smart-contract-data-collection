...
contract Ballot{
    ...
    function giveRightToVote(address voter) external
    {
        ...
        require(msg.sender == chairperson,"Only chairperson can give right to a person to vote");
    ...
    function winingName() external view returns(bytes32 winerName_)
    {

            winerName_ = proposals[winingProposal()].name;
    }
}
