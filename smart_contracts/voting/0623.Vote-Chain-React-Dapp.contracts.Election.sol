...
contract Election {
    ...
    function addCandidate(string memory _image, string memory _header, string memory _slogan)
        public
        // Only admin can add
        onlyAdmin
    {
    ...
    function getidProof() public view returns (string memory) {
        return electionDetails.idProof;
    }
    ...
    function registerAsVoter(string memory _name, string memory _voterId, string memory _idimage) public {
