    ...
    contract Bank5Contract {                                           
        ...
        uint256 private bank_balance;    // total balance of Bank5
        bytes32 private bank_name = "Bank5";
        ...
        function Bank5Contract(uint256 initBalance, address fisc_account, address admin_account)
        {   
