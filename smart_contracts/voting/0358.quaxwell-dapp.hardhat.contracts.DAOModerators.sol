...
contract DAOModerators {
  ...
  constructor(string memory _name, string memory _email, address _moderatorAddress) {
  ...
  function setNewModerator(
    ...
    address _moderatorAddress // ) public onlyOwner {
  ) public {
  ...
  function deleteModerators() public {
    delete moderators;
  }
}
