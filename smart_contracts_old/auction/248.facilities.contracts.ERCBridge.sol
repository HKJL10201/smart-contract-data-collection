...
contract ERC20Interchange is IERC20 {
 ...
 */
contract ERC20Burnable is ERC20Interchange {
 ...
 */
contract ERC20Mintable is ERC20Interchange, MinterRole {
 ...
 *
 */
contract ERC20Bridge is ERC20Interchange, ERC20Burnable, ERC20Mintable, Pausable {
    ...
    constructor (
        ...
        ERC20Interchange(initialAccount, _tokenSymbol, _tokenName, initialBalance) {
